...
<?php require __DIR__ . '/../layout/mensagem.php'; ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#modalConsultaVeiculo" title="Consultar Veículos">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Consultar Veículo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <div class="modal-body">

                    <input type="text" id="campoConsultaVeiculo" class="form-control mb-3" placeholder="Digite o código ou placa (Enter para buscar todos)">
